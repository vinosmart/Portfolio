export function useConstants() {
  ...
  //     description:
  //       "Completed my Bachelor's Degree in Mechanical Engineering at Surya group of institutions (MMU)",
  //     // icon: "",
  //   },
  //   {
  //     date: "March 2018",
  ...
  //     description:
  //       "Began my study in Mechanical Engineering at Surya group of institutions (MMU)",
  //     // icon: "",
  //     link: {
  //       text: "Visit MMU",
  ...
  const timeline = [
    ...
    {
      logo: "/work/lmes-logo.jpg",
      logoBorderColor: "transparent",
      companyName: "LMES Acedmy",
      ...
      jobScope: [
        ...
        "Leading a team to create a comprehensive company website and landing pages.",
      ],
    },
  ];
